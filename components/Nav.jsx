...
const Nav = ({ detail }) => {
  ...
  return (
    <nav className="relative">
      <div className="mb-8 flex max-w-full space-x-10 overflow-x-scroll whitespace-nowrap px-10 text-lg scrollbar-hide sm:space-x-10 sm:px-20 md:space-x-11 md:px-10 lg:px-12">
